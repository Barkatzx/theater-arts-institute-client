  ...
  return (
    <div className="bg-slate-100">
      <nav className="flex items-center justify-between p-4 shadow-xl text-xl font-semibold">
        ...
        <div className={isOpen ? 'flex flex-col md:flex-row md:relative md:top-16 md:right-0 md:bg-slate-100 w-full md:w-auto md:mt-0 md:flex md:items-center' : 'hidden md:flex md:items-center'}> 
          <Link
            to="/"
